    ...
    text: {
        1: (
            <div>
                ...
                Wasser und Abgasfreisetzung umfasst. Außerdem bei der Thematik, ob faire Bedingungen für die Menschen, die an
        ...
        4: (
            <div>
                ...
                kann und nicht immer die neuesten Dinge haben muss. So spart man Ressourcen, Geld und schützt die Umwelt.
            </div>
        ),
        5: (
            <div>
                <ul>
                    ...
                    <li>
                        {" "}
                        <p style={{ fontStyle: "italic" }}> Person 1: </p> „Mein Handybildschirm ist kaputt. Ich muss mir
                        dringend ein neues Handy kaufen!“{" "}
                    </li>
                    <li>
                        {" "}
        ...
        8: (
            <div>
                ...
                unbedingt trauen kann. Das ist zwar auch nicht immer bei Siegeln der Fall, doch Fairtrade ist ein recht
                bekanntes und seriöses Siegel. (Die Kennzeichnung zeigt jedoch manchmal nicht eindeutig an, ob die gesamte Produktionskette fair ist, oder nur Teile.)
            </div>
        ),
        9: (
            <div>
            ...
            <div>
                <ul>
                    ...
                    <li>
                        ...
                        eine Flasche Wasser. Wenn es nicht anders geht, dann nehme ich eben eine Plastikflasche.“
                    </li>
                    <li>
                        {" "}
        ...
        16: (
            <div>
                <ul>
                    ...
                    <li style={{ marginTop: "100px", fontStyle: "italic" }}>
                        {" "}
                        Scheinbar ist dein Konsum teilweise nachhaltig, aber er ist lange noch nicht perfekt. Aber vielleicht
        ...
        17: (
            <div>
                <ul>
                    ...
                    <li style={{ marginTop: "100px", fontStyle: "italic" }}>
                        {" "}
                        Scheinbar ist dein  Konsum schon sehr bewusst und nachhaltig, aber man kann immer dazulernen!. Vielleicht
                        merkst du dir ja, was du besser machen könntest und behältst bei, was du richtig gemacht hast.{" "}
                    </li>
                </ul>
            </div>
