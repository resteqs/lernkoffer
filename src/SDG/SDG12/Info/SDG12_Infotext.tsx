...
export const SDG12_Infotext: InfotextProps = {
    ...
    text: {
        ...
        5: "An vielen Orten auf dieser Welt wird das Konsumieren von Produkten nicht mehr nach „wie viel brauche ich?“, sondern nach „wie viel will ich?“ bestimmt. Dies hatte zur Folge, dass es im Jahre 2020 knapp drei Mal so viele Menschen auf der Welt gab, die Übergewichtig waren als die, die unter Hunger litten.",
        ...
        7: "Du kannst beim nächsten Einkauf darauf achten, nur Dinge zu kaufen, die du wirklich brauchst, umso weniger Müll zu verursachen. Du kannst außerdem energieeffizientere Geräte nutzen und deine alten Glühbirnen austauschen. Alte Kleidung oder Spielzeuge kannst du weiterschenken oder spenden und damit anderen eine Freude machen."
    },
    header: {
        2: "Warum?",
