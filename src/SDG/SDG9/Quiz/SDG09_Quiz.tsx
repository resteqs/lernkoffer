...
export const SDG09_Quiz:QuizProps = {
    ...
    buttonLeftContent: {3: <p style={{ fontSize: "100px" }}> existiert </p>,
                        5: <p style={{ fontSize: "100px" }}> existiert </p>,
                        7: <p style={{ fontSize: "100px" }}> existiert </p>,
                        9: <p style={{ fontSize: "100px" }}> existiert </p>,
                        11: <p style={{ fontSize: "100px" }}> existiert </p>,
                        12: <p style={{ fontSize: "100px" }}> existiert </p>,
                        13: <p style={{ fontSize: "100px" }}> existiert </p>,
                        },
    buttonRightContent:{3: <p style={{ fontSize: "100px" }}> für die Zukunft  </p>,
                        5: <p style={{ fontSize: "100px" }}> für die Zukunft  </p>,
                        7: <p style={{ fontSize: "100px" }}> für die Zukunft  </p>,
                        9: <p style={{ fontSize: "100px" }}> für die Zukunft  </p>,
                        11: <p style={{ fontSize: "100px" }}> für die Zukunft  </p>,
                        13: <p style={{ fontSize: "100px" }}> für die Zukunft  </p>,
