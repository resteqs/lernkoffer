...
export const SDG09_Quiz: QuizProps = {
    ...
    text: {
        1: (
            <p>
                {" "}
                Das 9. Nachhaltigkeitsziel heißt „Industrie, Innovation und Infrastruktur“ und in dieser Umsetzung
                konzentrieren wir uns auf den Aspekt „Innovation“. Erfindungen waren und sind schon immer sehr wichtig
                für den Menschen. Durch sie konnten wir uns weiterentwickeln zu der Gesellschaft, die wir heute sind.
                Wir haben Strom und Elektrizität, das Internet, Flugzeuge, Autos, Züge, Krankenhäuser mit OP-Sälen und
                Laboren, ausgebaute Städte mit einer organisierten Struktur und Fabriken mit Massenproduktion erfunden.
                Und dies sind nur ein paar Errungenschaften der letzten Jahrhunderte. Es gibt aber noch immer so viel
                mehr, was wir entwickeln können.{" "}
            </p>
        ),
        2: (
            <p>
                {" "}
                Besonders in der heutigen Zeit wird durchgehend geforscht und experimentiert. Im Folgenden nenne ich
                euch sechs Erfindungen und ihr sollt entscheidend, ob diese bereits existieren oder noch eine Idee für
                die Zukunft sind.{" "}
            </p>
        ),
        4: (
            <p>
                {" "}
                <img style={{ margin: "auto", display: "block", width: "30%" }} src={Banananblätter} alt="" />{" "}
            </p>
        ),
        6: (
            <p>
                {" "}
                <img style={{ margin: "auto", display: "block", width: "50%" }} src={SchwimmendeStadt} alt="" />{" "}
            </p>
        ),
        8: (
            <p>
                {" "}
                <img style={{ margin: "auto", display: "block", width: "50%" }} src={Roboter} alt="" />{" "}
            </p>
        ),
        10: (
            <p>
                {" "}
                <img style={{ margin: "auto", display: "block", width: "30%" }} src={Milch} alt="" />{" "}
            </p>
        ),
        12: (
            <p>
                {" "}
                <img style={{ margin: "auto", display: "block", width: "50%" }} src={Tierübersetzter} alt="" />{" "}
            </p>
        ),
        14: (
            <p>
                {" "}
                <img style={{ margin: "auto", display: "block", width: "50%" }} src={HolzausReishüllen} alt="" />{" "}
            </p>
        ),
    },
    question: {
    ...
    buttonLeftContent: {
        3: <p style={{ fontSize: "10.333vh" }}> existiert </p>,
    ...
    buttonRightContent: {
        3: <p style={{ fontSize: "10.333vh" }}> für die Zukunft </p>,
    ...
    answerNumbersLeft: { 3: " Richtig", 5: " Falsch ", 7: " Falsch", 9: " Richtig", 11: " Falsch ", 13: " Richtig" },
    answerNumbersRight: { 3: " Falsch ", 5: " Richtig", 7: " Richtig ", 9: " Falsch", 11: "Richtig", 13: "Falsch" },
    explanation: {
