...
export const SDG02_Infotext_Fable = (): JSX.Element => {
    ...
    const text = {
        ...
        4: `Es war nämlich kurz vor Winterbeginn und nicht mehr viele Karotten waren in der Erde zu finden. „Du hast nur die kleinen Karotten mitgebracht?“, fragte der Wolf. „Ja“, sprach der Hase, „aber ich muss dir auch sagen, dass ich nichts von deinem Reh essen werde.`,
        5: `Zum einen ist es viel zu groß für mich, zum anderen mag ich überhaupt kein Fleisch.“. Der Wolf war enttäuscht und zeigte kaum Verständnis: „Im Gegensatz zu dir, habe ich mir immerhin Mühe gegeben und für dich gejagt.Deine Karotten esse ich auch nicht, denn mir schmeckt kein Gemüse. Die musstest du eh einfach nur ausgraben.“`,
        6: ` Als der Hase dies hörte, wurde er wütend und stampfte mit der Hinterpfote. „Für dich ist es vielleicht einfach, für mich war es äußerst anstrengend sie zu finden. Und ich wäre bereit dazu gewesen dir mein Essen für eine ganze Woche anzubieten“, erklärte er und schaute den Wolf vorwurfsvoll an`,
        7: "Der Hase überlegte kurz, stimmte ihm dann zu und für das nächste Treffen machten sie bereits am Morgen davor einen gemeinsamen Ausflug aus. Durch den Hasen lernte der Wolf viele neue Tiere kennen, die mit ihm das Reh essen wollen und der Wolf holte dafür einige Karotten aus dem Lager seines Bekannten für den Hasen.",
    ...
    const header = {
        ...
        6: "Fabel – Der Wolf und der Hase",
        7: "Fabel – Der Wolf und der Hase",
        8: "Moral der Fabel",
        9: "Moral der Fabel",
        10: "Moral der Fabel",
        11: "Moral der Fabel",
