...
export const SDG02_Infotext_Fable = (): JSX.Element => {
    ...
    const text = {
        1: (
            <div>
                <p>
                    ...
                    mühsam am Abend davor alleine ausgegraben hatte.
                </p>
            </div>
        ),
        ...
        7: (
            <div>
                <p>
                    Der Hase überlegte kurz, stimmte ihm dann aber zu. Für das nächste Treffen machten sie bereits für
                    den Morgen davor einen gemeinsamen Ausflug aus. Durch den Hasen lernte der Wolf viele neue Tiere
                    kennen, die mit ihm das Reh essen wollten und der Wolf holte dafür einige Karotten für den Hasen aus
                    dem Lager eines Bekannten.
                </p>
            </div>
        ),
        ...
        8: (
            <div>
                <p>
                    ...
                    Lebensmittel da sind. Es kann ebenfalls passieren, dass die Ernte kaputt geht, nach zu viel oder zu
                    wenig Regen.{" "}
                </p>
            </div>
        ),
        ...
        10: (
            <div>
                <p>
                    ...
                    Nahrung helfen kann. Dabei können Fehler passieren und im schlimmsten Fall könnte die aktuelle Lage
        ...
        11: (
            <div>
                <p>
                    Weil die „Reichen“ nicht immer wissen, wie es „Armen“ geht, verstehen sie die Herausforderungen
                    nicht, die bei der benachteiligten Gemeinschaft tagtäglich bestehen.
                </p>
            </div>
        ),
        12: (
            <div>
                <p>
                    ...
                    werden kann, damit wie in diesem Beispiel der Wolf dem Hasen helfen kann, damit dieser nicht hungern
                    muss.
                </p>
            </div>
        ),
