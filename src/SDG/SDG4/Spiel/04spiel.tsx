...
import Modal, {
    ICustomModalStyle,
} from "@bdenzer/react-modal"; /* https://github.com/ben-denzer/react-modal#example---adding-custom-styles-in-typescript */
        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <button data-modal-id={modals.modalOne} type="button" onClick={this.openModal}>
                        {" "}
                        <img className="cards" alt="test" src={Cards} />
                    </button>
                    <button data-modal-id={modals.modalTwo} type="button" onClick={this.openModal}>
                        <img className="question" alt="test" src={Question} />
                    </button>
                </div>
            </div>
        );
