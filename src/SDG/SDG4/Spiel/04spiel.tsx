...
export const SDG04_Spiel = (): JSX.Element => {
    ...
    const ErklärenText = {
        ...
        6: " -> Bildung sollte für jeden und in allen Ländern verfügbar sein",
        7: " -> jeder soll über Nachhaltigkeit und ein nachhaltiges Leben lernen können",
    };
    ...
    const ZeichnenText = {
        ...
        7: "-> jedes Mal, wenn man etwas neu lernt, hat man Fragen und diese sollten auch beant-wortet werden können",
    };
    ...
    const PhantomimeText = {
        ...
        2: "-> es ist wichtig, dass weitere Bildungseinrichtungen gebaut werden bzw. die bestehenden verbessert werden",
        3: "-> Lehrer:innen sollten gut ausgebildet sein und überall ausreichend vorhanden sein",
        4: "-> alle Schüler:innen brauchen Hefte, um wichtige Dinge aufzuschreiben",
        5: "-> alle sollten die Möglichkeit haben, die Fähigkeiten zu erlernen, die es braucht, um eine Arbeit zu finden",
        6: "-> Sport ist gesund und in Lernpausen sollte man sich bewegen, dann fällt einem das Lernen danach auch wieder leichter",
        7: "-> beim Lernen sollte man immer mal wieder Pausen machen, damit sich das Gehirn erholen kann; z.B. draußen spielen",
    };
        ...
        1: (
            <div>
                <p className="EinleitungSDG04">
                    ...
                    geht es in diesem Spiel. Ihr werdet verschiedene Begriffe beschreiben, die bei hochwertiger Bildung
                    wichtig sind. Unter jedem Begriff steht eine Erklärung dazu, warum dieses Wort mit diesem Thema in
        ...
        2: (
            <div>
                <p className="SpielregelnSDG04">
                    ...
                    im Koffer beiliegende Spielfeld auf das „Start“-Feld. Holt euch als nächstes einen Würfel und
                    würfelt einmal reihum. Die Person mit der höchsten Augenzahl fängt an. Wenn ihr dran seid, würfelt
                    und geht so viele Bilder vorwärts, wie der Würfel anzeigt.
                </p>
            </div>
        ),
        3: (
            ...
            <div>
                <p className="SpielregelnSDG04" style={{ textAlign: "left" }}>
                    <ol>
                        ...
                        <li>- Beschreibt das nun abgebildete Wort innerhalb von 3 Minuten</li>
                        <li>
                            - Wie ihr es beschreiben sollt, hängt von dem Bild ab, auf dem ihr aktuell steht; aber dazu
                            gleich noch mehr
                        </li>
                        <li>
                            - Ist die Zeit abgelaufen, klickt außerhalb der “Karte“ und ihr gelangt zurück zum normalen
                            Spielfeld
                        </li>
        ...
        5: (
            <div>
                ...
                <p className="SpielregelnSDG04">
                    ...
                    dabei nicht reden oder irgendwelche Worte aufschreiben!
                </p>
                <p className="SpielregelnSDG04">
                    {" "}
                    <img src={Stickman} alt="" className="BildSDG4" /> → Beschreibt nur mit euren Händen und eurer
                    Körpersprache (das wird auch „Pantomime“ genannt). Ihr dürft nicht Reden, Worte aufschreiben oder
