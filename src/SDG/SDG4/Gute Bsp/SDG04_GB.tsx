...
export const SDG04_GB: QuizProps = {
    ...
    text: {
        ...
        2: (
            <p>
                Als nächstes werdet ihr ein paar Sätze vervollständigen. Wenn ihr damit fertig seid, könnt ihr euch
                nochmal alle Sätze durchlesen, damit ihr die gesamten Informationen wisst.
            </p>
        ),
        18: <div>
        <p>Malala Yousafzai wurde am 12. Juli 1997 in Pakistan geboren.</p>
        <p>2007 übernahm eine Gruppe radikaler Islamisten, die sogenannten „Taliban“, die Herrschaft über Malalas Heimat.</p>
        <p>Die Taliban wollen einen Gottesstaat errichten, in dem z.B. Frauen, in der Öffentlichkeit Ganzkörperschleier (Burkas) tragen müssen.</p>
        <p>Außerdem dürfen sie nicht arbeiten, ab 8 Jahren nicht mehr, zur Schule gehen und in Malalas Heimatregion keine Musik mehr hören.</p>
        <p>Darüber berichtete die Webseite des britischen TV-Senders BBC.</p>
        
        </div>,
        19: <p>
        <p>Nachdem Malalas Vater sie als Autorin für den Blog „Gul Makai“ (Kornblume) vorschlug, beschrieb Malala für 10 Wochen in kurzen Notizen die Unterdrückung durch die Taliban.</p>
        <p>In ihrer Heimat gab es Selbstmordattentate, Angst und Trauer und die Mädchen, zu denen auch Malala gehörte, durften nicht in die Schule.</p>
        <p>Sie wurde weltberühmt, trat in Fernsehshows auf und gab Interviews über Bildung und Frauen, da sie als eine der wenigen öffentlich sprach.</p>
        <p>Dafür erhielt sie Ende Dezember 2011 den pakistanischen Friedenspreis.</p>
        
        </p>,
        20: <div>
        <p>Die Bemühungen Malalas passten jedoch den Taliban nicht,  deshalb schossen sie das Mädchen im Oktober 2012 in einem Bus an.</p>
        <p>Sie wurde schwer verletzt, aber konnte nach längerer Behandlung wieder gesund werden.</p>
        <p>Seit März 2013 geht sie in Großbritannien wieder zur Schule.</p>
        <p>Sie gewann den internationalen Kinder-Friedenspreis und die UN erlaubte ihr an ihrem 16. Geburtstag (Juli 2013) eine Rede zu halten.</p>
        </div>,
        21: <div>
        <p>2014 bekam Malala den Friedensnobelpreis und 2017 wurde sie zur UN-Friedensbotschafterin, jeweils als jüngste Frau weltweit.</p>
        <p>Der 12. Juli, an dem Malala ihre Rede vor der UN hielt, wurde zum „Malala-Tag“, der jedes Jahr an das Recht aller Kinder, besonders von Mädchen, auf Bildung erinnern soll.</p>
        <p style={{ marginTop: "4vh" }}>Ich hoffe, nun weißt du ein bisschen mehr über Malala Yousafzai!</p>
        </div>,
    },
    question: {
    ...
    buttonLeftContent: {
        ...
        10: (
            <div style={{ fontSize: "50px" }}>
                Interviews über die Umwelt und die Tierarten in ihrer Heimat.
            </div>
        ),
        ...
        15: (
            <div style={{ fontSize: "60px" }}>
                erlaubte ihr an ihrem 16. Geburtstag (Juli 2013) eine Rede zu halten.
            </div>
        ),
        16: <div style={{ fontSize: "60px" }}>zur UN-Generalsekretärin, jeweils als jüngste Frau weltweit.</div>,
        17: (
            <div style={{ fontSize: "50px" }}>
                der jedes Jahr an das Recht aller Kinder, besonders von Mädchen, auf Bildung erinnern soll.
            </div>
        ),
    },
    buttonRightContent: {
        3: <div style={{ fontSize: "80px" }}>12. Juli 1997 in Großbritannien geboren.</div>,
        ...
        12: (
            <div style={{ fontSize: "65px" }}>
                deshalb schossen sie das Mädchen im Oktober 2012 auf offener Straße an.
            </div>
        ),
        ...
        15: (
            <div style={{ fontSize: "60px" }}>
                erlaubte ihr an ihrem 18. Geburtstag (Juli 2013) eine Rede zu halten.
            </div>
        ),
        16: <div style={{ fontSize: "60px" }}>zur UN-Friedens-botschafterin, jeweils als jüngste Frau weltweit.</div>,
        17: (
            <div style={{ fontSize: "44px" }}>
                der jedes Jahr an das Recht aller Kinder, besonders von Mädchen, auf Wohlstand erinnern soll.
            </div>
        ),
    },
    answerNumbersLeft: {
