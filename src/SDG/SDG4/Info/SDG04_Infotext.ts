...
export const SDG04_Infotext: InfotextProps = {
    ...
    sdg: "SDG04",
    text: {
        1: "“inklusive, gleichberechtigte und hochwertige Bildung gewährleisten und Möglichkeiten lebenslangen Lernens für alle fördern”",
        2: "Bildung ermöglicht Menschen den gesellschaftlichen Aufstieg. Damit bekommen sie mehr Vorteile, z.B. im Arbeitsleben und deshalb ist Bildung sehr wichtig, um der Armut zu entkommen. Sie hilft, Ungleichheiten zu verringern und die Gleichstellung der Geschlechter zu erreichen. Außerdem ist sie entscheidend für die Förderung von Toleranz (= Offenheit, frei von Vorurteilen) und friedlicheren Gesellschaften. In den letzten zehn Jahren wurden große Fortschritte erzielt: es gibt einen besseren Zugang zu Bildung und mehr Kinder, besonders Mädchen, können in die Schule gehen. Dennoch waren im Jahr 2018 immer noch rund 258 Millionen Kinder und Jugendliche nicht eingeschult - fast jede:r Fünfte auf der ganzen Welt in diesem Alter.",
        3: "Es gibt noch sehr viele Menschen, die wenig Bildung haben und das obwohl immer mehr Einschulungen jedes Jahr stattfinden. Rund 773 Millionen Erwachsene konnten 2018 nicht lesen und schreiben, zwei Drittel davon waren Frauen. Ein weiteres Problem ist die Tatsache, dass Schulen oft schließen müssen oder nicht alles anbieten, was Schüler haben sollten. So fehlt es beispielsweise an grundlegenden Dingen, wie Trinkwasser, aber auch an Geld, Strom, Computern oder Internet. In jedem dritten sogenannten „Entwicklungsland“ (ein Land, das sich noch weiterentwickeln soll, damit es den Einwohner:innen dort besser geht) haben Frauen und Mädchen es schwer, gebildet zu werden. Daher können sie nicht so viele Fähigkeiten erlernen wie Jungen und haben eingeschränkte Chancen auf dem Arbeitsmarkt.",
        4: "Obwohl einige Länder hoch digitalisiert sind (also Strom, Computer, Internet und andere technische Dingen besitzen), gibt es auch solche, die kaum vernetzt sind. Dieser Unterschied zwischen den Ländern mit digitalen Medien und ohne muss verkleinert werden, damit alle die gleichen Chancen auf eine hochwertige Bildung haben. Ansonsten verschlimmern sich die Ungleichheiten.",
        5: "Es ist wichtig, dass deine Regierung Bildung als bedeutsam ansieht, sowohl in der Politik als auch im wirklichen Leben. Wenn du die Möglichkeit hast, mit einem Politiker darüber zu sprechen oder ihn auf andere friedliche Weise zu erreichen (z. B. durch Abstimmungen, Wahlen, Petitionen usw.), solltest du sie nutzen. Wenn du wirklich erfolgreich sein willst, versuche, eine feste Zusage von der verantwortlichen Person zu bekommen. Im Allgemeinen ist es ein guter Anfang, für eine kostenlose Grundschulbildung für alle zu kämpfen, auch für benachteiligte Gruppen.",
    },
    header: {
        2: "Warum?",
