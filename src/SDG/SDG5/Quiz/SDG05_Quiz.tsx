...
export const SDG05_Quiz: QuizProps = {
    ...
    text: {
        ...
        2:(
         ...
         <div> Dazu habe ich ein Quiz für euch vorbereitet!
                <ul style={{ marginTop: "30px" }}>
                    ...
                    nicht! Wer findet, dass sich das so gehört, hebt den Daumen nach oben, wenn nicht dann nach unten.{" "}</li>
                </ul>{" "}
            </div>
        ),
        3: <div> Danach möchte ich euch erklären, warum das so ist. Diese Erklärungen könnt ihr anschließend mit euren eigenen Überlegungen vergleichen und vielleicht auch darüber diskutieren </div>,
        11: <div> Falls ihr euch fragt, wie ich auf das komme, was ich euch gerade gesagt habe: Ich beziehe mich auf den in der „Allgemeinen Erklärung der Menschenrechte“ der UNO festgehaltenen Grundsatz, „Alle Menschen sind frei und gleich an Würde und Rechten geboren“. Dadurch wird gesagt, dass unabhängig von Geschlecht, Herkunft, Religion und vielen weiteren Sachen jeder Mensch die gleichen Rechte hat Bei manchen von den Beispielen, die ich euch gerade genannt habe, wurden Menschenrechte verletzt. Manchmal habe ich euch auch einfach ein Zitat aus der „Allgemeinen Erklärung der Menschenrechte" dazugegeben! </div>, 
        12: <div> Ich hoffe, ihr erkennt durch diese Beispiele jetzt besser, wo Frauen und Männer ungleich behandelt werden! </div>, 
    },
    ...
    buttonLeftContent: {4: <p> <img style= {{ height: "300px" }} src= {thumbup} alt="" /> </p>,
                    5: <p> <img style= {{ height: "300px" }} src= {thumbup} alt="" /> </p>,
                    6: <p> <img style= {{ height: "300px" }} src= {thumbup} alt="" /> </p>,
                    7: <p> <img style= {{ height: "300px" }} src= {thumbup} alt="" /> </p>,
                    8: <div> <img style= {{ height: "300px" }} src= {thumbup} alt="" /> </div>, 
                    9: <div>  <img style= {{ height: "300px" }} src= {thumbup} alt="" /></div>, 
                    10: <div>  <img style= {{ height: "300px" }} src= {thumbup} alt="" /></div>
                    },
    buttonRightContent:{4: <p> <img style= {{ height: "300px" }} src= {thumbdown} alt="" /> </p>,
                    5: <p> <img style= {{ height: "300px" }} src= {thumbdown} alt="" /> </p>,
                    6: <p> <img style= {{ height: "300px" }} src= {thumbdown} alt="" /> </p>,
                    7: <p> <img style= {{ height: "300px" }} src= {thumbdown} alt="" /> </p>,
                    8: <div><img style= {{ height: "300px" }} src= {thumbdown} alt="" />  </div>, 
                    9: <div><img style= {{ height: "300px" }} src= {thumbdown} alt="" />  </div>, 
                    10: <div><img style= {{ height: "300px" }} src= {thumbdown} alt="" />  </div> ,
    },
    answerNumbersLeft:{ 
                    4: "Falsch",
                    5: "Richtig",
