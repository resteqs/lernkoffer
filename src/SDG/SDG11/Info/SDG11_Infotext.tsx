...
export const SDG11_Infotext: InfotextProps = {
    ...
    text: {
        ...
        2: "Die Anzahl der Leute, die in städtischen Regionen leben, nimmt sehr stark zu und damit gehen auch viele Probleme einher, mit denen sich die Menschen beschäftigen müssen. Einige davon sind eine immer schlimmer werdende Luftverschmutzung, ungerechte Infrastruktur und öffentliche Dienste sowie die Zersiedelung (dass viele Menschen in die Städte ziehen, diese aber nicht ausreichend geplant sind). Darüber hinaus sind sichere öffentliche Transportmittel, vertrauenswürdige öffentliche Dienste und Parks sehr wichtig, um die Gesundheit der Bevölkerung zu sichern.",
        3: "Zweifellos das größte Problem ist, dass ein großer Teil vieler Städte „Slums“ sind, also Stadtviertel, in denen die Menschen keinen Zugang zu einer funktionierenden Infrastruktur (Buse, Bahnen, …), Wasser, Abwasser- und Müllsystemen haben, um die schlechten Wohnbedingungen nicht zu erwähnen. Dazu kommt noch, dass die öffentlichen Transportmittel und Gesundheitseinrichtungen immer stärker überlastet sind.",
        4: "Wenn Menschen keinen Zugang zu öffentlichen Transportmitteln haben, sind sie mehr oder weniger dazu gezwungen, selbstständig mit dem Auto zu fahren, wenn sie längere Strecken zurücklegen müssen. Das wiederrum würde eine extreme Luftverschmutzung verursachen, was schlecht für unser Klima und die Umwelt ist.",
        5: "Konkret heißt das, dass im Jahr 2000 circa 28 Prozent der städtischen Bevölkerung weltweit in „Slums“ gelebt hat wobei diese Zahl bis zum Jahr 2014 auf 23 Prozent abgenommen hat. Allerdings hat diese Zahl im Jahr 2018 wieder zugenommen und stand bei 24 Prozent, was ungefähr eine Milliarde Menschen widerspiegelte.",
        6: "Laut Daten von 2019 hatten aus 610 Städten in insgesamt 95 Ländern nur etwa die Hälfte der städtischen Bevölkerung Zugang zu „kleinen“ öffentlichen Transportmittel (Busse/Straßenbahnen) in einer Distanz von unter 500 Meter zu Fuß und Zugang zu „großen“ öffentlichen Transportmitteln“ (Bahnen/U-Bahnen/Fähren) in einer Distanz von unter 1.000 Meter zu Fuß.",
