...
export const SDG11_Infotext: InfotextProps = {
    ...
    text: {
        ...
        3: "Zweifellos das größte Problem ist, dass ein großer Teil vieler Städte „Slums“ sind, also Stadtviertel, in denen die Menschen keinen Zugang zu einer funktionierenden Infrastruktur (Busse, Bahnen, …), Wasser-, Abwasser- und Müllsystemen haben, um die schlechten Wohnbedingungen nicht zu erwähnen. Dazu kommt noch, dass die öffentlichen Transportmittel und Gesundheitseinrichtungen immer stärker überlastet sind.",
