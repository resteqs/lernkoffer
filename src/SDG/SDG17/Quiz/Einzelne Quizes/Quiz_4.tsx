...
export const SDG17_Quiz_4: Quiz3Mixed = {
    ...
    question: {
        ...
        5: "Wer ist wichtiger Bestandteil einer Schule?",
        7: "Was sollte jede:r in der Schule dabei haben?",
    },
    buttonLeftContent: {
        1: <p style={{ fontSize: "90px" }}>Jungs</p>,
        3: <p style={{ fontSize: "50px" }}>Skateboard fahren, Fußball spielen, Ballett tanzen </p>,
        5: <p style={{ fontSize: "69px" }}>Lehrer:innen </p>,
        7: <p style={{ fontSize: "69px" }}>Eine Pflanze </p>,
    },
    buttonMiddleContent: {
        1: <p style={{ fontSize: "90px" }}>Mädchen</p>,
        3: <p style={{ fontSize: "60px" }}>Malen, Singen, Seilspringen </p>,
        5: <p style={{ fontSize: "69px" }}>Renn- fahrer:innen </p>,
        7: <p style={{ fontSize: "70px" }}>Stifte und Hefte </p>,
    },
    buttonRightContent: {
        1: <p style={{ fontSize: "90px" }}>Reiche Kinder</p>,
        3: <p style={{ fontSize: "60px" }}>Lesen, Schreiben, Rechnen </p>,
        5: <p style={{ fontSize: "65px" }}>Friseur:innen </p>,
        7: <p style={{ fontSize: "70px" }}>Ein Kissen </p>,
    },
    answerNumbersLeft: {
        1: "Falsch",
        3: "Falsch",
    ...
    explanation: {
        ...
        5: "Sie helfen dir dabei, neue Dinge zu lernen und können dir etwas erklären, wenn du es nicht verstehst",
        7: "Mit diesen Dingen kannst du wichtige Sachen aufschreiben, die du in der Schule lernst",
    },
