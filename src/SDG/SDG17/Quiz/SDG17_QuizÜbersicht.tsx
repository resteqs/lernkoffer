    ...
    text: {
        ...
        2: (
            <p>
                ...
                auf eines der farbigen Felder kommt, drückt auf dem Tablet auf die entsprechende Nummer des
                Nachhaltigkeitsziels und euch wird eine Frage zu diesem gestellt. Findet ihr die richtige Antwort, dürft
                ihr 3 Felder vorrücken, wenn nicht müsst ihr ein Feld zurück. Kommt ihr beim unteren Ende einer Leiter
                an, dürft ihr sie nach oben klettern zu dem Feld an dem sie endet. Wenn ihr bei dem oberen Ende eines
                blauen Wasserfalls steht, fällt ihr diesen herunter und müsst zum Feld zurück, an dem er endet. Wer als
                Erster das Ziel erreicht hat gewonnen.
            </p>
        ),
        3: (
            <div>
                ...
                <div style={{ marginLeft: "520px" }}><LogoButton URL="/SDG17/Quiz15" Logo={Logo15}/></div>
