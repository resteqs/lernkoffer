...
export const ray:TextProps = {
    ...
    text: {
        1: "Wir müssen etwas tun. Rochen sind meist nur Beifang, doch in der traditionellen chinesischen Medizin spielen sie eine wichtige Rolle.",
        2: (
