...
export const bicycle: TextProps = {
    ...
    text: {
        1: (
            <div>
                Ein Fahrradfahrer stößt etwa 21g CO<sub>2</sub> pro Kilometer aus, was mehr als zehnmal weniger als beim Autofahren ist!
                Außerdem ist es gesund, Fahrrad zu fahren, und hilft, den Lärm in Städten zu reduzieren. Wenn du Geld
