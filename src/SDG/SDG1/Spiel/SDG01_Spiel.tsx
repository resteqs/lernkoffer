...
export const SDG01_Spiel: TextProps = {
    ...
    header: {
        ...
        23: "Möglicher Grund für unterschiedliche Gehälter: ",
    },
    text: {
        1: (
            <div>
        ...
        2: (
            <div>
                {" "}
                Du wirst gleich jeweils zwei Steckbriefe (oder nur den Namen) zu unterschiedlichen Berufen angezeigt
        ...
        3: (
            <div>
                <ul>
                    ...
                    <li>
                        {" "}
                        Die hier genannten Zahlen beziehen sich auf durchschnittliche Einstiegsgehälter in Deutschland
                        aus dem Jahr 2019.
                    </li>
                </ul>
            </div>
            ...
            <div>
                <ul>
                    ...
                    <li style={{ marginLeft: "4vh", marginTop: "2.667vh" }}>
                        ...
                        sitzen oder mit Kunden im Gespräch sein, das kann durchaus auch sehr anstrengend sein.{" "}
                    </li>
                </ul>
            </div>
        ),
            ...
            <div>
                <ul>
                    ...
                    <li style={{ marginLeft: "4vh", marginTop: "2.667vh", }}>
                        ...
                        immer im Kopf behalten, was der Kunde sich wünscht. Bei diesem Beruf ist besonders die Zeit, in
                        der du mit dem Kunden erarbeitest, wie das gewünschte Produkt aussehen soll, anspruchsvoll.
                        Gerade aus dem Grund, weil Kunden oftmals auf deinem Fachgebiet nur wenig Wissen haben und so
                        nicht exakt bestimmen können, was sie brauchen, diesen Schritt musst immer du als Grafiker:in
                        machen. Grafiker:innen arbeiten mittlerweile sehr viel an digitalen Geräten, was auf Dauer auch
            ...
            <div>
                <ul>
                    ...
                    <li style={{ marginTop: "6.667vh" }}>
                        ...
                        das, oder überlegt in der Gruppe.
                    </li>
                </ul>
            </div>
        ),
            ...
            <div>
                <ul>
                    ...
                    <li style={{ marginLeft: "4vh", marginTop: "2.667vh" }}>
                        ...
                        Kompetenzen solltest du besitzen, das heißt, dass du dich gut ausdrücken und Sachen auch Leuten,
                        die nicht unbedingt vom Fach sind, verständlich erklären kannst.
                    </li>
                </ul>
            </div>
        ),
            ...
            <div>
                <ul>
                    ...
                    <li style={{ marginLeft: "4vh", marginTop: "2.667vh" }}>
                        ...
                        wenige sind zum Beispiel die Forschung an neuen Energiequellen, die besser für unsere Umwelt
                        sind. Oder die Forschung an dem Ursprung des Universums in der Physik.
                    </li>
                </ul>
            </div>
        ),
        ...
        20: (
            <div>
                {" "}
                Meinst du, dass eine Person, die als Gärtner:in oder eine Person, die als Forscher:in arbeitet mehr
                verdient? Und warum meinst du, dass das so ist?{" "}
            </div>
        ),
        21: (
            <div>
        ...
        23: (
            <div>
                {" "}
                Manche Menschen argumentieren auch damit, dass Forscher:innen „wichtiger“ für die Menschen sind als
                Gärtner:innen. Aber es gibt gute Argumente dafür, dass Gärtner:innen genauso wichtig sind. Zum Beispiel
                sind sie diejenigen, die dafür sorgen, dass unsere Pflanzen und damit unsere Umwelt gesund bleiben oder
                es wieder werden. Außerdem ist es doch viel schöner, wenn eine Grünanlage gut gepflegt wird und hübsch
                aussieht. Dann macht das Spielen an der frischen Luft gleich viel mehr Spaß.{" "}
            </div>
        ),
    },
