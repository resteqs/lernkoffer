...
*/
    const headera  = [
        { id: 1, text: <p> </p> },
        { id: 2, text: <p>Warum?</p> },
        { id: 3, text: <p>Was ist das Problem?</p> },
        { id: 4, text: <p>Was ist das Problem?</p> },
        { id: 5, text: <p>Was können wir tun?</p> },       
    ...
    const header = [
        { id: 1, text: " " },
        { id: 2, text: "Warum?" },
        { id: 3, text: "Was ist das Problem?" },
        { id: 4, text: "Was ist das Problem?" },
        { id: 5, text: "Was können wir tun?" },       
    ]
