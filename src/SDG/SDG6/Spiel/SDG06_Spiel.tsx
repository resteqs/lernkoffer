        ...
        1: (
            <div>
                <p className="EinleitungSDG04" style={{ fontSize: "45px" }}>
                    Wasser ist ein Stoff, den alle Menschen, alle Tiere und alle Pflanzen zum Leben brauchen. Er
                    begegnet dir in vielen verschiedenen Situationen. Ich möchte mit euch ein kleines Spiel zum Thema
                    Wasser spielen. Lest euch hierfür erst einmal die ganze Anleitung durch, bereitet alles vor und
                    einigt euch auf ein Ende des Spiels.
                </p>
            </div>
        ),
        2: (
            <div>
                <p className="SpielregelnSDG04" style={{ fontSize: "45px" }}>
                    Zuallererst benötigt ihr das laminierte Blatt, das als Spielfeld dient. Am meisten Spaß macht es, in
                    einer Gruppe zu spielen. Jede:r Spieler:in benötigt eine Spielfigur (diese findet ihr im Koffer).
                    Wenn sich jede:r eine Figur ausgesucht hat, stellen alle Teilnehmer:innen die eigene Spielfigur auf
                    das erste Feld (roter Kreis), also das, über dem „Start“ steht.
                </p>
            </div>
        ),
        3: (
            <div>
                <p className="SpielregelnSDG04" style={{ fontSize: "45px" }}>
                    Legt eine Reihenfolge fest, in der ihr würfelt. Danach würfelt der/die erste Spieler:in mit dem
                    Würfel, den ihr in dem Koffer findet. Die Anzahl der Augen, die geworfen wurde, entspricht der
                    Anzahl der Felder, um die die Spielfigur nach vorne bewegt werden darf. Wurde dies erledigt ist der
                    Zug beendet und der / die nächste Spieler:in ist an der Reihe.
                </p>
            </div>
        ),
        4: (
            <div>
                <p className="SpielregelnSDG04" style={{ fontSize: "45px" }}>
                    Doch Vorsicht: Landet ihr auf einem der Felder, an denen eine Gedankenblase mit einer Zahl zu sehen
                    ist, lest euch den kleinen Text durch, der zu dieser Zahl gehört und befolgt die kurzen Anweisungen.
                </p>
            </div>
        ),
        5: (
            <div>
                <p className="SpielregelnSDG04" style={{ fontSize: "45px" }}>
                    ...
                    1. Entweder ihr beendet das Spiel, sobald die erste Figur an dem Feld, über dem „Ziel“ steht,
                    ankommt.
                    <br />
                    2. Oder es wird so lang gespielt, bis auch die letzte Figur am Ende ankommt.
                    <br />
                    <br />
