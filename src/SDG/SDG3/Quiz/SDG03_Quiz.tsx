...
export const SDG03_Quiz: TextProps = {
    ...
    text: {
        ...
        6: (
            <div>
                <p>
                    ...
                    sind. Ordnet am Ende die Bilder jeweils den Plätzen 1-3 zu. Platz 1 ist für die Sache, die eurer
                    Meinung nach am schlimmsten für den Körper ist, Platz 3 für das, was laut euch am wenigsten
                    schädlich ist. Tipp: Denkt hier eher an die Folgen für den Menschen, wenn er es bereits lange zu
                    sich genommen hat.{" "}
                </p>
            </div>
        ),
        7: (
            <div>
                <p>
                    ...
                    Geschmack hat. In den Getränken, die man im Supermarkt kaufen kann, ist aber immer nur ein kleiner
        ...
        8: (
            <div>
                <p>
                    ...
                    Getränken ist, dass man <b>süchtig</b> danach werden kann, wenn man diese regelmäßig trinkt, da sich
                    der Körper an deren Wirkung gewöhnt. Dies wird dann „Alkoholsucht“, „Alkoholkrankheit“ oder
                    „Alkoholismus“ genannt. Dabei wird jedoch die Leber auf lange Sicht sehr überlastet, weil sie dann
                    ständig daran arbeiten muss, den Alkohol abzubauen. Aber auch <b>andere Organe</b> in deinem Bauch
                    (z.B. der Magen), das <b>Herz</b> und das <b>Gehirn</b> nehmen auf Dauer Schaden. Zusätzlich steigt
                    das Risiko an verschiedenen Arten von <b>Krebs</b> zu erkranken.
                </p>
            </div>
        ),
        9: (
            <div>
                <p>
                    ...
                    die in Zigarettenpapier eingerollt sind. Tabak ist eigentlich eine grüne Pflanze, deren Blätter
                    jedoch für die Zigaretten getrocknet und zerkleinert werden.{" "}
                </p>
        ...
        10: (
            <div>
                <p>
                    ...
                    schneller schlägt, wodurch auch das Blut schneller fließt. Das ist auf Dauer nicht gut für das Herz
                    und die <b>Blutgefäße </b>
                    (das sind kleine Röhrchen im Körper, durch die das Blut fließt). Jedoch kann man durch das Nikotin
                    und dessen Wirkung <b>süchtig</b> nach Zigaretten werden. Dann muss man immer wieder rauchen,
                    ansonsten wird man gereizt und ruhelos.{" "}
                </p>
            </div>
        ),
        11: (
            <div>
                <p>
                    Aber wusstet ihr schon, dass in Zigaretten noch andere schädliche Stoffe außer Nikotin enthalten
                    sind? Insgesamt sind <b>mehr als 40 Stoffe </b>im Rauch nachweislich <b>krebserregend</b>. Einer
                    davon ist zum Beispiel
                    <b> Teer</b>. Dieser zerstört kleine Härchen, welche die Lunge sauber halten sollen. Sollten diese
        ...
        12: (
            <div>
                <p>
                    Die abgebildeten Blätter sind von der Hanf- bzw. Cannabispflanze. Die weiblichen Blüten und die
                    Blätter dieser Pflanze werden, wenn man sie trocknet, <b>Marihuana</b> genannt. Das Harz der Pflanze
                    wird <b>Haschisch </b>
                    genannt.{" "}
                </p>
                <img
        ...
        13: (
            <div>
                <p>
                    Am häufigsten wird Marihuana oder Haschisch geraucht, indem man es zerbröselt und mit Tabak von
                    normalen Zigaretten vermischt und zu einem sogenannten <b>Joint</b> dreht. Dieser sieht meist einer
                    selbst gedrehten Zigarette ähnlich, wie man auf dem unten gezeigten Bild sehen kann. Andere
                    Möglichkeiten wären auch noch über unterschiedliche Arten von Pfeifen zu rauchen oder
                    Cannabisprodukte in Keksen etc. zu verbacken und dann zu essen.{" "}
                </p>
                <img
        ...
        14: (
            <div>
                <p>
                    ...
                    Beispiel, dass der Körper deutlich länger braucht THC abzubauen als bei Alkohol. Außerdem leidet die
        ...
        15: (
            <div>
                <p>
                    ...
                    <b>Teer und andere Schadstoffe</b> enthält. Noch dazu verursacht es ein erhöhtes
                    <b> Herzinfarktrisiko</b> und bei wiederholtem Konsum <b>Abhängigkeit</b>.
                </p>
            </div>
        ),
        16: (
            <div>
                <p>
                    ...
                    am besten (<b>Platz 3</b>) und am schlchtesten (<b>Platz 1</b>) für den Körper ist. Ich sage euch
                    gleich, wie es tatsächlich ist. Drückt sobald ihr fertig seid einfach auf weiter, dann werdet ihr
                    die Lösung sehen.
                </p>
            </div>
        ),
        ...
        18: (
            <div>
                <p>
                    ...
                    Drogen, also wird man von ihnen in einen Rausch versetzt. Obwohl Alkohol und Zigaretten, und in
                    manchen Ländern auch Cannabis, legal (gesetzlich erlaubt) sind, muss man vorsichtig mit ihnen umgehen.
                    Die Gefahr ist immer vorhanden, süchtig zu werden und sie alle sind schädigend für die Gesundheit.
